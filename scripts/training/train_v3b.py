...
LR_BACKBONE     = 5e-5
WEIGHT_DECAY    = 1e-3
EPOCHS          = 12          # full run for sub-20 push
WARMUP_EPOCHS   = 2
BATCH_SIZE      = 24
NUM_WORKERS     = 2
UNFREEZE_BLOCKS = 4
VAL_FRAC        = 0.20
CHIPS_TRAIN     = 12          # midpoint between 8 and 16 — more data, still fast
CHIPS_VAL       = 24
USE_BF16        = True
HUBER_DELTA     = 10.0
ZERO_THRESH     = 0.50
SEED            = 99
OUT_DIR         = ROOT / "models" / "checkpoints" / "prithvi_yield_v3b"
LOG_PATH        = ROOT / "reports" / "training_logs" / "train_v3b_log.csv"
